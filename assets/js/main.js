(function(){"use strict";const select=(el,all=!1)=>{el=el.trim()
  ...
  const portfolioLightbox=GLightbox({selector:'.portfolio-lightbox'});new Swiper('.testimonials-slider',{speed:600,loop:!0,autoplay:{delay:5000,disableOnInteraction:!1},slidesPerView:'auto',pagination:{el:'.swiper-pagination',type:'bullets',clickable:!0}});new Swiper('.portfolio-details-slider',{speed:400,loop:!0,autoplay:{delay:5000,disableOnInteraction:!1},pagination:{el:'.swiper-pagination',type:'bullets',clickable:!0}});let preloader=select('#preloader');if(preloader){window.addEventListener('load',()=>{preloader.remove()})}
  new PureCounter()})()